...
const SAMPLE_DATA: Record<string, any[]> = {
  ...
  events: [
    ...
    },
    {
      ...
      'virtual-link': 'https://training.example.com/osha-virtual-backup',
      category: 'Training',
    ...
    },
    {
      ...
      'virtual-link': 'https://teams.microsoft.com/meet/happy-hour-virtual',
      category: 'Social Event',
      description: '<p>Join your colleagues for an evening of fun and networking. First round on the company!</p>',
      capacity: 50,
      'registration-link': 'https://forms.example.com/happy-hour-rsvp',
      'is-mandatory': false,
      'is-virtual': false
    },
    {
  ...
  'culture-stories': [
    ...
    },
    {
      ...
      'video-url': 'https://www.youtube.com/watch?v=downtown-plaza-completion',
      ...
      'person-tenure': 'Multiple tenures',
      quote: 'When everyone pulls together, there\'s nothing we can\'t accomplish.',
    ...
    },
    {
      ...
      'person-name': 'Safety Department',
      'person-role': 'Safety Leadership',
      'person-tenure': 'Ongoing commitment',
    ...
    },
    {
      ...
      type: 'Milestone',
      'featured-image': PLACEHOLDER_PHOTO,
      'video-url': 'https://www.youtube.com/watch?v=tom-25-years',
  ...
  'it-knowledge-base': [
    ...
    },
    {
      ...
      'download-link': 'https://it.jewettconstruction.com/downloads/printer-troubleshooting-guide.pdf',
      platform: 'Windows',
      difficulty: 'Intermediate',
      views: 423,
      'helpful-votes': 31,
