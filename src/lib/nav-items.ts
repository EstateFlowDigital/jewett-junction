...
export interface NavItem {
  ...
  fallback: string;
  /** Idea submission is amber; the crisis plan is red so it reads as an emergency link. */
  accent?: 'amber' | 'red';
}
...
export const NAV_PRIMARY: NavItem[] = [
  ...
  // Direct route to the crisis plan document, in addition to where it lives
  // under Safety → Resources: in an actual crisis nobody should be navigating.
  { slug: 'crisis-plan', href: '/jewett-junction/resources/jewett-construction-crisis-management-plan', fallback: 'Crisis Management Plan', accent: 'red' },
  { slug: 'hr', href: '/jewett-junction/hr', fallback: 'HR' },
  { slug: 'finance', href: '/jewett-junction/finance', fallback: 'Finance' },
