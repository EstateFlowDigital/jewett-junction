...
export const COLLECTIONS: Record<string, CollectionConfig> = {
  ...
  quickActions: {
    ...
    fields: [
      ...
      { key: 'destination-url', label: 'Destination URL', type: 'url', placeholder: '/jewett-junction/it-helpdesk', helpText: 'Where the card links to. Internal paths or full URLs.', icon: 'Link' },
