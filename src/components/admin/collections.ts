...
export const COLLECTIONS: Record<string, CollectionConfig> = {
  ...
  quickActions: {
    ...
    slug: 'quick-actions',
    description: 'The 4-up action cards at the top of HR, Safety, IT, and other landing pages. Filter by Page Slug to control which page each card appears on.',
    fields: [
      ...
      { key: 'page-slug', label: 'Page Slug', type: 'select', required: true, options: ['hr', 'safety', 'it', 'marketing', 'resources', 'culture', 'careers', 'directory', 'events'], helpText: 'Which landing page this card appears on', icon: 'Tag' },
