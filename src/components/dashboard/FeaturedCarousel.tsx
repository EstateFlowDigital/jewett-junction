            ...
            >
              ...
              >
                {announcement.imageUrl ? (
                  ...
                  <div className="h-36 w-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">
                ...
                <div className="p-4">
                  ...
                  <h3 className="text-base font-bold text-white mb-2 line-clamp-2 group-hover:text-blue-200 transition-colors">
                    {announcement.name}
                  </h3>
                  {announcement.excerpt && (
                    <p className="text-blue-100/80 text-sm mb-3 line-clamp-2">
                      {announcement.excerpt}
                    </p>
                  )}
