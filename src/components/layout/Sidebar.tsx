  ...
  return (
    ...
    >
      ...
      <div className="flex h-14 items-center justify-center">
        <a href="/dashboard" aria-label="Jewett Junction Home" className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors">
