...
import _styles from "./ElementIndustriesTabContentIndustries.module.css";

export function ElementIndustriesTabContentIndustries({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Block tag="div">{industryName}</_Builtin.Block>
            </_Builtin.DOM>
          </_Builtin.DOM>
          <_Builtin.Block
            className={_utils.cx(
      ...
      <GlobalClickable link={industriesPageLink} text="Explore Industry" />
    </_Component>
  );
}
