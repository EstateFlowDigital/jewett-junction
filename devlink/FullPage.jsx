...
import _styles from "./FullPage.module.css";

export function FullPage({ as: _Component = _Builtin.Block }) {
  return (
    <_Component className={_utils.cx(_styles, "page_wrap")} tag="div">
      ...
      >
        <GlobalNavbar />
        <SectionHeroInternalPage stylesTheme="light" />
        <SectionPortfolio styleTheme="dark" />
        ...
        <SectionTestimonials styleTheme="dark" />
        <SectionCta
          styleTheme="dark"
