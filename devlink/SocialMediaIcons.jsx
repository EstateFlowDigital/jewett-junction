...
import _styles from "./SocialMediaIcons.module.css";

export function SocialMediaIcons({ as: _Component = _Builtin.Block }) {
  return (
    <_Component className={_utils.cx(_styles, "footer_social_wrap")} tag="div">
      <_Builtin.List
        className={_utils.cx(
          _styles,
          "footer_social_list",
      ...
      >
        <_Builtin.ListItem className={_utils.cx(_styles, "footer_social_item")}>
          <_Builtin.Link
            ...
            block="inline"
            options={{
              href: "https://www.facebook.com/JewettConstruct",
              target: "_blank",
            }}
          >
            <_Builtin.Block
        ...
        <_Builtin.ListItem className={_utils.cx(_styles, "footer_social_item")}>
          <_Builtin.Link
            ...
            block="inline"
            options={{
              href: "https://www.instagram.com/jewettconstruct/",
              target: "_blank",
            }}
          >
            <_Builtin.Block
        ...
        <_Builtin.ListItem className={_utils.cx(_styles, "footer_social_item")}>
          <_Builtin.Link
            ...
            block="inline"
            options={{
              href: "https://www.linkedin.com/company/jewett-construction-co-inc-/",
              target: "_blank",
            }}
          >
            <_Builtin.Block
        ...
        <_Builtin.ListItem className={_utils.cx(_styles, "footer_social_item")}>
          <_Builtin.Link
            ...
            block="inline"
            options={{
              href: "https://www.youtube.com/@JewettConstructionCo",
              target: "_blank",
            }}
          >
            <_Builtin.Block
