...
import _styles from "./SectionKitInfo.module.css";

export function SectionKitInfo({
      ...
      >
        ...
        >
          <_Builtin.TabsMenu
            ...
            id={_utils.cx(
              _styles,
              "w-node-ad187d57-2b2e-8c72-2a79-3ae8065aa3b9-065aa3b5"
            )}
            tag="div"
          >
            <_Builtin.TabsLink
            ...
            >
              ...
              >
                <_Builtin.Heading tag="h3">
                  {"Lead Times & "}
                  <_Builtin.Span>{"Customization"}</_Builtin.Span>
                </_Builtin.Heading>
              </_Builtin.Block>
            </_Builtin.TabsLink>
          </_Builtin.TabsMenu>
          ...
          >
            ...
            >
              <ElementServicesTabContentServicePage
                leftParagraphRichText={tab1LeftText}
                paragraphRichTex={tab1ParagraphRichText}
                headingTab1ContentRichText=""
                rightParagraphRichText={
                  <_Builtin.Paragraph>
                    {"Taped components must be at least 5 inches long."}
                  </_Builtin.Paragraph>
                }
              />
            </_Builtin.TabsPane>
            <_Builtin.TabsPane tag="div" data-w-tab="Tab 2">
              <ElementServicesTabContentServicePage
                paragraphRichTex={tab2Paragraph}
                leftParagraphRichText={
                  <_Builtin.Paragraph>
                    {"Fiducials and silkscreen designators are essential."}
                  </_Builtin.Paragraph>
                }
                headingTab1ContentRichText={
                  <_Builtin.Heading tag="h3">
                    {"Board Requirements for Optimal Assembly Performance"}
                  </_Builtin.Heading>
                }
                rightParagraphRichText={
                  <_Builtin.Paragraph>
                    {"Ensure components are placed away from board edges."}
                  </_Builtin.Paragraph>
                }
              />
            </_Builtin.TabsPane>
            <_Builtin.TabsPane tag="div" data-w-tab="Tab 3">
              <ElementServicesTabContentServicePage
                paragraphRichTex={tab3ParagraphR}
                leftParagraphRichText={
                  <_Builtin.Paragraph>
                    {"Handle loose ICs with static precautions."}
                  </_Builtin.Paragraph>
                }
                headingTab1ContentRichText={
                  <_Builtin.Heading tag="h3">
                    {"Component Handling & Care for Optimal PCB Performance"}
                  </_Builtin.Heading>
                }
                rightParagraphRichText={
                  <_Builtin.Paragraph>
                    {"Tray components must be uniformly aligned."}
                  </_Builtin.Paragraph>
                }
              />
            </_Builtin.TabsPane>
            <_Builtin.TabsPane tag="div" data-w-tab="Tab 4">
              <ElementServicesTabContentServicePage
                paragraphRichTex={tab4ParagraphRich}
                leftParagraphRichText={
                  <_Builtin.Paragraph>
                    {"Flexible lead times for fast turnarounds."}
                  </_Builtin.Paragraph>
                }
                headingTab1ContentRichText={
                  <_Builtin.Heading tag="h3">
                    {"Flexible Lead Times & Custom PCB Assembly Customization"}
                  </_Builtin.Heading>
                }
                rightParagraphRichText={
                  <_Builtin.Paragraph>
                    {"Customization options tailored to your project needs."}
                  </_Builtin.Paragraph>
                }
              />
            </_Builtin.TabsPane>
