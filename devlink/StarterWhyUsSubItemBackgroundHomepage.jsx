...
import _styles from "./StarterWhyUsSubItemBackgroundHomepage.module.css";

export function StarterWhyUsSubItemBackgroundHomepage({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "why_us_subitem_bg")}
      tag="div"
