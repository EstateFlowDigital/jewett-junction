...
import _styles from "./GlobalContent.module.css";
...
export function GlobalContent({
  ...
  const _styleVariantMap = {
    Base: "",
    "Content is Center": "w-variant-be0bb1ba-1494-fd40-1076-7d2f9218bbb0",
    "v-flex-between": "w-variant-71f736a8-9b36-b906-d9e6-a380a868a34b",
  };
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <GlobalEyebrow
              ...
              eyebrowEyebrowIsLeftAligned={eyebrowEyebrowIsLeftAligned}
              ...
              eyebrowIconViewbox={eyebrowEyebrowIconViewbox}
              eyebrowIconPath1={eyebrowIconPath1}
              eyebrowFeaturedTextVisibility={eyebrowFeaturedTextVisibility}
      ...
      <_Builtin.Block
        ...
        tag="div"
      >
        {headingHeadingVisibility ? (
          <_Builtin.DOM
            className={_utils.cx(_styles, "heading_wrap", _activeStyleVariant)}
            tag="div"
            slot=""
            _class={headingStyle}
          >
      ...
      {buttonGroupButtonGroupVisibility ? (
        ...
        >
          <BtnMain
            ...
            subtext={button1Subtext}
            subtextVisibility={button1SubtextVisibility}
            iconIconVisibility={button1IconVisibility}
            iconIconViewbox={button1IconViewbox}
            iconSvgPath1={button1IconSvgPath1}
          />
          <BtnMain
            visibility={button2Button2Visibility}
            link={button2Button2Link}
            subtext={button2Button2Subtext}
            subtextVisibility={button2Button2SubtextVisibility}
            iconIconVisibility={button2Button2IconVisibility}
            iconIconViewbox={button2Button2IconViewbox}
            iconSvgPath1={button2Button2SvgPath1}
